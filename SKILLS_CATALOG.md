...
| 5 | 文献检索下载 | `skills/literature-search-download/` | F2 | 执行 | 乙 | `feat/f2-landscape` | 未开始 |
| 6 | 文献精读入库 | `skills/literature-reader/` | F2+F3 | 执行 | 乙（丙复用） | `feat/f2-landscape` | 未开始 |
| 7 | 文献全景撰写 | `skills/literature-landscape-writer/` | F2 | 执行 | 乙 | `feat/f2-landscape` | 未开始 |
| 8 | 引用核对 | `skills/citation-verifier/` | F2 | 自动程序 | 乙 | `feat/f2-landscape` | 未开始 |
| 9 | 关系可视化 | `skills/survey-visualizer/` | F2 | 执行 | 乙 | `feat/f2-landscape` | 未开始 |
| 10 | 单篇深读 | `skills/paper-deep-read/` | F3 | 工作流 | 丙 | `feat/f3-deep-read` | 未开始 |
| 11 | 阶段进展整理 | `skills/progress-digest/` | F4 | 工作流 | 本周未派人 | — | 未开始 |
...
3. **F4（progress-digest）** 本周未派人：需要本地材料时由丁降级处理（用户粘贴要点），或下周单开。
